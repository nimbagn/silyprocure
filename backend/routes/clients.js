    ...
    try {
        const [stats] = await pool.execute(`
            SELECT 
                ...
                COUNT(CASE WHEN date_derniere_demande >= DATE_SUB(NOW(), INTERVAL 30 DAY) THEN 1 END) as clients_actifs_30j,
                COUNT(CASE WHEN date_derniere_demande >= DATE_SUB(NOW(), INTERVAL 90 DAY) THEN 1 END) as clients_actifs_90j,
